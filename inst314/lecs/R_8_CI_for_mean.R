...
# We want to devise a procedure that
# generates an interval for each sample
# of the sampling distribution, such that
# 95% of these intervals contain the
# population mean.
# we want the intervals to be in the form: 
# POINT ESTIMATE +/- MARGIN OF ERROR
# What to use as point estimate?
# What to use as margin of error?

# note that these are equivalent: 
# 1) 95% of sample means are within 2sd
# distance from the population mean
# 2) the mean is within 2sd distance of 
...
#many samples, for each of them 
#calculates mean and sd, and also the 
# x% CI via my_mean +- z* my_sd/my_sampleSize, 
#and see how many of these sampling attempts
#produce CIs that capture the true mean.
