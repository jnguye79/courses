...
) ENGINE=InnoDB AUTO_INCREMENT=132466128 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `person_classifications` (
  `person_id` int NOT NULL,
  `classification_id` int NOT NULL,
  PRIMARY KEY (`person_id`,`classification_id`),
...
CREATE TABLE `person_pronoun` (
  ...
  PRIMARY KEY (`person_id`,`pronoun_id`),
...
CREATE TABLE `section_location` (
  `section_id` int NOT NULL,
  `location_id` int NOT NULL,
  PRIMARY KEY (`section_id`,`location_id`),
...
-- Dump completed on 2022-04-03 15:50:58
