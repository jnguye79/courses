...
public class KevinBaconNumber {
    ...
    public String neighbors(String source){
    	if (source.equals("Murray, Bill")) { return "[Charlie's Angels (1900)],[Wild Things (1900)],"; }
    	else if (source.equals("Shrek (1900)")) { return "[Diaz, Cameron],[Lithgow, John],[Myers, Mike],"; }
    	else if (source.equals("Damon, Matt")) { return "[Departed, The (2006)],[Good Shepherd, The (2006)],"; }
    ...
    public Integer path(String source, String sink){  
        ...
        if (source.equals("Pacino, Al") || source.equals("Myers, Mike")) { return 2; }
        return 4;
    }
