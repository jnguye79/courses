...
public class Tests{
	...
	public void testBoggleOne() throws IOException {
		...
		System.out.println(game.findWord("FIND"));
		System.out.println(game.findWord("AID"));
		System.out.println(game.findWord("FIT"));
		System.out.print("\n");
